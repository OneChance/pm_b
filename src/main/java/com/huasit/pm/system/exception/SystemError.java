package com.huasit.pm.system.exception;
...
public enum SystemError {
    ...
    ATTENDANCE_APPLY_NOT_TODAY(6000),
    ATTENDANCE_NOT_STUDY(6001),
    IMPORT_FIELD_EMPTY(7001),
    IMPORT_FIELD_NOT_MATCH(7002),
    IMPORT_FIELD_DUPLICATE(7003);
